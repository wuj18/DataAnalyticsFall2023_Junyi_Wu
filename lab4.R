...
par(mfrow=c(1,2))
plot(cars2$speed, cars2$dist, xlim=c(0, 28), vlim=c(0, 230), main="With Outliers", xlab="speed", ylab="dist", pch="*",col="red", cex=2)
abline(lm(dist ~speed, data=cars2), col="blue", lwd=3, lty=2)
# Plot of original data without outliers. Note the change in slope (angle) of best fit line.
plot(cars1$speed, cars1$dist, xlim=c(0, 28), vlim=c(0, 230), main="Outliers removed in A much better fit!", xlab="speed",ylab="dist", pch="*",col="red", cex=2)
